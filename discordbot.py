...
async def check(ctx, arg):
    ...
    try:
        if (driver.find_element_by_xpath("/html/body/div[3]/div/main/div[2]/div[2]/div[1]/div[2]")):
            ...
            embed2=discord.Embed(title="shdw's DMV - License Plate Checker", url="https://www.dmv.ca.gov/portal/vehicle-registration/license-plates-decals-and-placards/california-license-plates/order-special-interest-and-personalized-license-plates/", description="The license plate " + arg + " is NOT available! :x: ", color=discord.Color.red())
            await message.edit(embed=embed2, content=f"It's NOT available!")
            pass
    except:
        pass
    try:
